...
import { Calendar, UserPlus, LogOut, Menu, ClipboardList } from "lucide-react";
...
const links = [
  { href: "/receptionist", label: "Appointments", icon: Calendar },
  { href: "/doctor/patients/new", label: "Register Patient", icon: UserPlus },
];
...
export function ReceptionistSidebar({ user }) {
    ...
    <>
      ...
      <aside className="hidden lg:flex lg:w-60 lg:flex-col lg:border-r bg-background shrink-0">
        <div className="flex h-14 items-center gap-2 px-4 border-b">
          <ClipboardList className="h-5 w-5 text-primary" />
          <span className="font-semibold text-base sm:text-lg">Receptionist Portal</span>
        </div>
        <div className="flex-1 overflow-y-auto">
